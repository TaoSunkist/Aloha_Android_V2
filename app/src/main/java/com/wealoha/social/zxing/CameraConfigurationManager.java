...
/**
 * A class which deals with reading, parsing, and setting the camera parameters which are used to configure
 * the camera hardware.
 * 
 * <br/>
 * 
...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		int height = UiUtils.getScreenHeight(context);
		XL.d("displaydisplay", width + "" + height);
		if (width < height) {
			int temp = width;
			width = height;
			height = temp;
