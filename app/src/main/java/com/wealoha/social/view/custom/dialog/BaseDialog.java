...
public class BaseDialog extends Dialog implements View.OnClickListener {
	...
	public BaseDialog(Context context) {
		...
		mContext = context;
		View view = LayoutInflater.from(context).inflate(R.layout.common_dialog_generic, null);
		setContentView(view);
	...
	public static BaseDialog getDialog(Context context, CharSequence title, CharSequence message, CharSequence button1, OnClickListener listener1) {
		return getDialog(context, title, message, button1, listener1, null, null, null, null);
	}

	public static BaseDialog getDialog(Context context, CharSequence title, CharSequence message, CharSequence button1, OnClickListener listener1, CharSequence button2, OnClickListener listener2) {
		return getDialog(context, title, message, button1, listener1, button2, listener2, null, null);
	}

	public static BaseDialog getDialog(Context context, CharSequence title, CharSequence message, CharSequence button1, OnClickListener listener1, CharSequence button2, OnClickListener listener2, CharSequence button3, OnClickListener listener3) {
