...
public class MyNumberPicker extends LinearLayout {
	...
	public static final MyNumberPicker.Formatter TWO_DIGIT_FORMATTER = new MyNumberPicker.Formatter() {
	...
	public MyNumberPicker(Context context, AttributeSet attrs) {
		...
		// mSolidColor =
		// attributesArray.getColor(R.styleable.NumberPicker_solidColor, 0);
		mSolidColor = 0;
		// mFlingable =
		// attributesArray.getBoolean(R.styleable.NumberPicker_flingable, true);
		mFlingable = true;
		mSelectionDivider = new ColorDrawable(getResources().getColor(R.color.numpicker_gray_line));
		// mSelectionDivider =
		...
		mMaxHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 200, getResources().getDisplayMetrics());
		// mMaxHeight = SIZE_UNSPECIFIED;
		if (mMinHeight != SIZE_UNSPECIFIED && mMaxHeight != SIZE_UNSPECIFIED && mMinHeight > mMaxHeight) {
			throw new IllegalArgumentException("minHeight > maxHeight");
		}
		mMinWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 48, getResources().getDisplayMetrics());
		...
		FontUtil.setRegulartypeFace(getContext(), mInputText);
		...
		// final ObjectAnimator showIncrementButton =
		// ObjectAnimator.ofFloat(mIncrementButton, PROPERTY_BUTTON_ALPHA,
		// BUTTON_ALPHA_TRANSPARENT, BUTTON_ALPHA_OPAQUE);
		// final ObjectAnimator showDecrementButton =
		// ObjectAnimator.ofFloat(mDecrementButton, PROPERTY_BUTTON_ALPHA,
		// BUTTON_ALPHA_TRANSPARENT, BUTTON_ALPHA_OPAQUE);
	 ...
	 * <p>
	 * If the argument is less than the {@link MyNumberPicker#getMinValue()} and
	 * {@link MyNumberPicker#getWrapSelectorWheel()} is <code>false</code> the current value is set to the
	 * {@link MyNumberPicker#getMinValue()} value.
	 * </p>
	 * <p>
	 * If the argument is less than the {@link MyNumberPicker#getMinValue()} and
	 * {@link MyNumberPicker#getWrapSelectorWheel()} is <code>true</code> the current value is set to the
	 * {@link MyNumberPicker#getMaxValue()} value.
	 * </p>
	 * <p>
	 * If the argument is less than the {@link MyNumberPicker#getMaxValue()} and
	 * {@link MyNumberPicker#getWrapSelectorWheel()} is <code>false</code> the current value is set to the
	 * {@link MyNumberPicker#getMaxValue()} value.
	 * </p>
	 * <p>
	 ...
	 * {@link MyNumberPicker#getMinValue()} and {@link MyNumberPicker#getMaxValue()} values.
	 * <p>
	...
	private void setSelectorWheelState(int selectorWheelState) {
		...
		// String text =
		// mContext.getString(R.string.number_picker_increment_scroll_action);
	...
	private void updateInputTextView() {
		/*
		 * If we don't have displayed values then use the current number else find the correct value in the
		...
		// AccessibilityManager.getInstance(mContext).isEnabled()) {
		// String text =
		// mContext.getString(R.string.number_picker_increment_scroll_mode,
		// mInputText.getText());
		// mInputText.setContentDescription(text);
		// }
	}
