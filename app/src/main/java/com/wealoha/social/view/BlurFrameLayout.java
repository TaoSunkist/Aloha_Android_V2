...
package com.wealoha.social.view;
...
import com.wealoha.social.render.BlurRenderer;
...
public class BlurFrameLayout extends FrameLayout {
	 ...
	 * Default constructor
	 */
	public BlurFrameLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs) {
		...
		for (int i = 0; i < a.getIndexCount(); ++i) {
			...
			if (attr == R.styleable.BlurView_blur_radius) {
