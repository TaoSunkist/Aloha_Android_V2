...
public class ImageFeedHolder extends BaseFeedHolder implements OnClickListener {
	...
	private void createAtOnePopup(UserTag userTag) {
		XL.i("Profile2HeaderHolder", "null---" + userTag.getUser().getAvatarCommonImage());
		XL.i("Profile2HeaderHolder", "post null---" + mPost.getUserTags().get(0).getUser().getAvatarCommonImage());
