...
import com.wealoha.social.beans.match.MatchData;
...
public class LoadingFragment extends BaseFragment implements LoaderCallbacks<com.wealoha.social.beans.Result<MatchData>> {
	...
	private void loadUserPhoto() {
		if (contextUtil.getCurrentUser() != null) {
			picasso.load(ImageUtil.getImageUrl(contextUtil.getCurrentUser().avatarImage.id, UiUtils.dip2px(context, GlobalConstants.ImageSize.AVATAR_ROUND_SMALL), CropMode.ScaleCenterCrop))//
