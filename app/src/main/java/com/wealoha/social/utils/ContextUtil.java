...
public class ContextUtil {
	...
	public void setCurrentUser(User user) {
		...
		if (user != null && contextHolder != null && currentUser != null) {
			if (currentUser != null) {
				user.isShowAlohaTimeDialog = currentUser.isShowAlohaTimeDialog;
				user.isShowFeedDialog = currentUser.isShowFeedDialog;
			}
		}
