...
public class ProFeatureAct extends BaseFragAct implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPromotionGetData = (PromotionGetData) getIntent().getParcelableExtra(PromotionGetData.TAG);
    ...
    private void initView(PromotionGetData data) {
        ...
        ruleTv.setText(getString(R.string.invite_a_friend_to_get_the_invitation_code, String.valueOf(data.getQuotaPerPerson())));
    ...
    private void initProFeatureLayout(ArrayList<Profeature> features) {
        ...
        if (mPromotionGetData.getAlohaGetLocked()) {
            if (mPromotionGetData.getQuotaReset() > 0) {
    ...
    private void initFeatureListData(PromotionGetData proGetData) {
        int titleId;
        if (proGetData.getAlohaGetLocked()) {
        ...
        String title = null;
        if (proGetData.getQuotaReset() != 0) {
            title = getString(R.string.label_invite_quota_reset_str, String.valueOf(proGetData.getQuotaReset()));
        }
        addProfeature(title,//
    ...
    private void showDialog() {
        ...
        bundle.putParcelable(PromotionGetData.TAG, mPromotionGetData);
