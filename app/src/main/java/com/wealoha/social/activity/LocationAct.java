...
public class LocationAct extends BaseFragAct implements OnClickListener {
    ...
    public void initDataFromServer() {
        ...
        if (msd == null) {
            regionNodes = ((RegionNode) getIntent().getSerializableExtra(RegionNode.TAG)).getRegions();
        } else {
        ...
        for (String key : keys) {
            ...
            if (value.getRegions() != null && value.getRegions().size() > 0) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (regionNodes.get(keys.get(position)).getRegions() != null) {
    ...
    public void initData() {
        ...
        if (TextUtils.isEmpty(region)) {
            ...
            regionNodes = rnu.getByCode(region).getRegions();
        }
