...
public class AdvancedFeaturesAct extends BaseFragAct implements LoaderManager.LoaderCallbacks<ApiResponse<PromotionGetData>> {
        ...
        switch (v.getId()) {
            ...
            case R.id.send_sms_share_to_friends_rl:
                ...
                sendIntent.putExtra("sms_body", getResources().getString(R.string.advance_features_gay_aloha_Invitation, //
                        data.getPromotionCode(), "http://wealoha.com/get"));
    ...
    private void updateData(PromotionGetData data) {
        this.data = data;
        textQuotaResetLeft.setText(getString(R.string.label_invite_quota_reset_left, data.getQuotaReset()));

        textQuotaResetRules.setText(getString(R.string.label_invite_quota_reset_get, data.getQuotaPerPerson()));
        // 邀请码
        textPromotionCode.setText(getString(R.string.label_invite_promotion_code, data.getPromotionCode()));
        // TODO 第三方邀请使用的文案
    }
